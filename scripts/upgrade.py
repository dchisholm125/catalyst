"""Back up an existing v1 database before Catalyst's additive v2 migration.
    ...
    if path.exists():
        with sqlite3.connect(path) as source:
            ...
            if versions == [1]:
                ...
                backup = path.with_name(f"{path.stem}.pre-v2-{stamp}.db")
...
if __name__ == "__main__":
    ...
    print("Database ready at schema version 2. Existing content and credentials preserved.")
