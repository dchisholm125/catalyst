"""Back up an existing database before Catalyst's additive v5 migration.
    ...
    if path.exists():
        with sqlite3.connect(path) as source:
            ...
            if versions != [5]:
                ...
                backup = path.with_name(f"{path.stem}.pre-v5-{stamp}.db")
...
if __name__ == "__main__":
    ...
    print("Database ready at schema version 5. Existing content and credentials preserved.")
