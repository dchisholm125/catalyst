"""Back up an existing database before Catalyst's additive v6 migration.
    ...
    if path.exists():
        with sqlite3.connect(path) as source:
            ...
            if versions != [6]:
                ...
                backup = path.with_name(f"{path.stem}.pre-v6-{stamp}.db")
...
if __name__ == "__main__":
    ...
    print("Database ready at schema version 6. Existing content and credentials preserved.")
